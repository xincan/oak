package cn.com.tarotframework.server.oak.vo;
...
public class UserSearchVo implements Serializable {
    ...
    private static final long serialVersionUID = 2231512615661676780L;
    ...
    @ApiModelProperty(value="创建时间", dataType = "org.joda.time.LocalDateTime", example = "2022-12-12 23:23:23")
    ...
    @ApiModelProperty(value="编辑时间", dataType = "org.joda.time.LocalDateTime", example = "2022-12-12 23:23:23")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonDeserialize(using = LocalDateTimeDeserializer.class)
    @JsonSerialize(using = LocalDateTimeSerializer.class)
